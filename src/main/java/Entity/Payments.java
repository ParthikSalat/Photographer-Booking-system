...
@NamedQueries({
    ...
    @NamedQuery(name = "Payments.findByPhotographerAmount", query = "SELECT p FROM Payments p WHERE p.photographerAmount = :photographerAmount"),
    @NamedQuery(name = "Payments.findByPlatformCommission", query = "SELECT p FROM Payments p WHERE p.platformCommission = :platformCommission")})
public class Payments implements Serializable {
    ...
    @Column(name = "PhotographerAmount")
    ...
    public BigDecimal getPhotographerAmount() {
        return photographerAmount;
    }

    public void setPhotographerAmount(BigDecimal photographerAmount) {
        this.photographerAmount = photographerAmount;
    }
